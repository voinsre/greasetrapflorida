  ...
  const jsonLd: Record<string, unknown>[] = [
    {
      ...
      image: guide.image_url || '/images/og-image.webp',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Guides', item: 'https://greasetrapflorida.com/guides' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex items-center flex-wrap gap-1 text-sm">
            ...
            <li><a href="/guides" className="text-gray-400 hover:text-amber-600 transition-colors">Guides</a></li>
            <li><ChevronRight className="w-3.5 h-3.5 text-gray-400" /></li>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <article className="flex-1 min-w-0">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">{guide.title}</h1>
            <MarkdownContent content={guide.content.split(/## Frequently Asked Questions/i)[0]} />
                  ...
                  <ul className="space-y-2">
                    {headings.map((h) => (
                      <li key={h.id}>
                        <a
                          href={`#${h.id}`}
                          className="text-sm text-gray-500 hover:text-amber-600 transition-colors block"
                        >
                          {h.text}
                        </a>
                      </li>
